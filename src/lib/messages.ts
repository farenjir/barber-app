...
export const MESSAGES = {
  ...
  customer: {
    requestBarberCode: 
      ...
      `می‌توانید از طریق تلگرام یا لینک وب آرایشگر نوبت رزرو کنید.`,
    ...
    help: 
      `*راهنمای مشتری:*\n\n` +
      `• برای رزرو نوبت از تلگرام، کد آرایشگر خود را وارد کنید\n` +
      `• یا از لینک وب آرایشگر برای رزرو استفاده کنید\n` +
      ...
      `• از «ورود به وب» برای دسترسی به نوبت‌های خود در وب استفاده کنید\n\n` +
